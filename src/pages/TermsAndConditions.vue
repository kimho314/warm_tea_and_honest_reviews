  ...
  <div class="terms-and-conditions-page">
    <div class="content-container">
      ...
      <section>
        ...
        <p>The term “you” refers to anyone who uses, visits and/or views the website. Warm Tea & Honest Reviews LLC reserves the right to amend or modify these terms and conditions in its sole discretion at any time without notice and by using the website, you accept those amendments. It is your responsibility to periodically check the website for updates.</p>
      ...
      <section>
        <h2>AGE AND UNITED STATES USE ONLY</h2>
        <p>All information and content on this website are intended for individuals over the age of 18. Children, as defined in our Privacy Policy, are prohibited from using this website. We do not envision offering products or services to individuals living in the European Union as outlined in the General Data Protection Regulation. Additionally, we make no representation that the information provided on the website including any products and/or services are available or appropriate for use in other locations including but not limited to the European Union as outlined in the General Data Protection Regulation.</p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>(f) send unsolicited or unauthorized material or cause disruption in the operation of the website.</li>
        </ul>
        <p>You agree to use the website for lawful purposes only and shall be liable for damages resulting from the violation of any provision contained in these Terms and Conditions.</p>
      </section>
      ...
      <section>
        <h2>CONTACT</h2>
        <p>For any questions, please contact us at <a href="mailto:kimho314@gmail.com">kimho314@gmail.com</a></p>
      </section>
    </div>
  </div>
</template>
