  ...
  <div class="privacy-policy-page">
    <div class="content-container">
      ...
      <section>
        ...
        <p>Based on our interest in the prevention of spam and abuse, this website also uses Google reCAPTCHA (hereinafter “reCAPTCHA”). reCAPTCHA is used to determine whether data entered on this website (such as on a newsletter sign up form) has been entered by a human or an automated program. reCAPTCHA includes the sending of your IP address and possibly other data required by Google for the reCAPTCHA service to Google. Additional information about reCAPTCHA and Google’s privacy policy can be found at: https://policies.google.com/privacy and https://www.google.com/recaptcha/intro/v3.html</p>
      </section>
      ...
      <section>
        ...
        <p>We do not envision offering goods or services to individuals living in the European Union as outlined in the General Data Protection Regulation (“GDPR”).</p>
      ...
      <section>
        ...
        <ol>
          <li>You ask us to delete the information by sending a request to support@bookishwayfarer.com. Please note that such requests may result in you no longer being able to access paid or free content previously provided to you.</li>
      ...
      <section>
        <h2>CONTACT</h2>
        <p>For any questions or comments regarding the privacy policy, please contact us at kimho314t@gmail.com</p>
      </section>
    </div>
  </div>
</template>
